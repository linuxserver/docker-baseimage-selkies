...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f 42b3b741da458d8b12ac8b915fa082ebeb4a4c50
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/42b3b741da458d8b12ac8b915fa082ebeb4a4c50.tar.gz" && \
  cd /tmp && \
