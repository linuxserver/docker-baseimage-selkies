...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f 2ffa79c04f1f816bb8713ef49b3f30bf12fc49e6
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/2ffa79c04f1f816bb8713ef49b3f30bf12fc49e6.tar.gz" && \
  cd /tmp && \
