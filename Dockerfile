...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f f7cc030cb102f4fff03b1d6729c4a1d4af6aa364
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/f7cc030cb102f4fff03b1d6729c4a1d4af6aa364.tar.gz" && \
  cd /tmp && \
