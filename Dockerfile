...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f 942d06b04dc842f82383cc0d18321f0026fcafc4
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/942d06b04dc842f82383cc0d18321f0026fcafc4.tar.gz" && \
  cd /tmp && \
