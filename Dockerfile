...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f ab788a8bca6a06dc9124e3eadb78838517fed382
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/ab788a8bca6a06dc9124e3eadb78838517fed382.tar.gz" && \
  cd /tmp && \
