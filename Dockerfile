...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f d58b5363bade194322e24fa9fbd1294e13dddbce
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/d58b5363bade194322e24fa9fbd1294e13dddbce.tar.gz" && \
  cd /tmp && \
