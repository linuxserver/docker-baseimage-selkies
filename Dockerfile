...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f aa45021b96cb207d4a04601cd91c0f51bf48a630
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/aa45021b96cb207d4a04601cd91c0f51bf48a630.tar.gz" && \
  cd /tmp && \
