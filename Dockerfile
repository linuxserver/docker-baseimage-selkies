...
RUN \
  ...
  curl -o \
    /tmp/web.tar.gz -L \
    "https://github.com/selkies-project/selkies/releases/download/${SELKIES_RELEASE}/selkies-gstreamer-web_${SELKIES_RELEASE}.tar.gz" && \
  curl -o \
    /tmp/selkies.tar.gz -L \
    "https://github.com/selkies-project/selkies/archive/refs/heads/main.tar.gz" && \
  tar xf \
    /tmp/web.tar.gz -C \
