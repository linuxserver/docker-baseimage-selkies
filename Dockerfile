...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f ca7381ccbeeaa8daadadbeb3a281dfd47be959f0
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/ca7381ccbeeaa8daadadbeb3a281dfd47be959f0.tar.gz" && \
  cd /tmp && \
