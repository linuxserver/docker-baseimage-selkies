...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f 9f31ffee5d2969716ecf559bdd955a595d192b87
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/9f31ffee5d2969716ecf559bdd955a595d192b87.tar.gz" && \
  cd /tmp && \
