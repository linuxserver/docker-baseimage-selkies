...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f 371f9981be40b7e8aba0b6a4c95453299ce7fe2f
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/371f9981be40b7e8aba0b6a4c95453299ce7fe2f.tar.gz" && \
  cd /tmp && \
