...
RUN \
  ...
  git clone \
    ...
    /src && \
  cd /src && \
  git checkout -f aae6a4de653bb95da0a6b820f885fb6b30a5e35c
...
RUN \
  ...
  curl -o \
    ...
    "https://github.com/selkies-project/selkies/archive/aae6a4de653bb95da0a6b820f885fb6b30a5e35c.tar.gz" && \
  cd /tmp && \
