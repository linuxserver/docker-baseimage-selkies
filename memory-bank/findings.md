...
**Status**: ✅ artifact side complete 2026-08-28 (verified: replicated 19-sed render + YAML parse + structural cross-check ALL PASS). Cluster-side E2E pending (needs NRP kube access: pull secret + PSA check + template swap + run).
