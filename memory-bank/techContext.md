...
## RHEL9 Target Stack (PLAN v4 — vetted 2026-08-27; evidence: `tasks/2026-08/270827_rhel9-vetting-plan-v4.md`)
...
| absent/accepted | — | dunst (nothing launches it), cvt (graceful no-op). **NOT gaps (vetting)**: xdg-utils (AppStream 1.1.3 — D6), breeze-cursor-theme (EPEL9, no RPMFusion needed) |
