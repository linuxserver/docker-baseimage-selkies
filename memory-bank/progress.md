...
2. **Roadmap (deferred by user 2026-08-28, intel complete + fix verified — F53–F55)**: R1 proot-apps (dashboard app install/update actually working: ship `/proot-apps`, bwrap stub for glycin apps, optional SLU catalog) — full plan in `activeContext.md#Roadmap`; runtime side now unblocked (F55: docker default allows ptrace)
