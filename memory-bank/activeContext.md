...
**Revert tag**: `pre-gnome-desktop` → `b4c199f`. **Final image**: `dgilli/baseimage-selkies:rhel9-p1-gnome` = `99da8c1475f5` (c7, SLU wallpaper).
...
**Intel complete, fix verified, NOT yet in the image.** Findings F53–F55.
